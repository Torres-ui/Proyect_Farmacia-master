...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        if (txtUsuario.getText().isEmpty() || txtContraseña.getText().isEmpty()) {
            ...
            String buscarUsuario = Metodos_sql.UsuarioInvitado(txtUsuario.getText(), txtContraseña.getText());
            ...
            if (busqueda_usuario.equals("USUARIO ENCONTRADO")) {
                ...
                String busquedaUsuario = Metodos_sql.buscarUsuario(txtUsuario.getText());
                ventana.lblNombreUsuario.setText(busquedaUsuario);

                String busqueda_Rol = Metodos_sql.buscarTipoUsuario(txtUsuario.getText());
                ventana.lblRol.setText(busqueda_Rol);

                String busqueda_Id = Metodos_sql.buscarId(txtUsuario.getText());
